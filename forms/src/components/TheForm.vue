  ...
  <form @submit.prevent="submitFrom">
    <div class="form-control">
      ...
      <input id="user-name"
             ...
             @blur="validateInput"
      />
      <p v-if="!userNameValid">error user name</p>
    </div>
    <div class="form-control">
...
<script>
import TheCustomControl from './TheCustomControl.vue';
...
export default {
  ...
  methods: {
    submitFrom() {
      ...
      console.log(JSON.parse(JSON.stringify(this.interest)))
      console.log(this.how.target)
